...
//checking content type of file.     
   out.print(item.getContentType());
    ...
    if(  item.getContentType().equalsIgnoreCase("application/vnd.ms-excel") )
    {
        ...
        out.print("url --> " + archivo_server );
        out.print("Nombre --> " + item.getName() );
        out.print("<br> Tipo --> " + item.getContentType());
        out.print("<br> tamaño --> " + (item.getSize()/1240)+ "KB");
        out.print("<br>");
        out.print("<img src='archivos/"+item.getName()+"' width=300 height=300 />");
        /* guardar los datos en la tabla */
        /* fin guardar */
        }
        else
        {
            out.print("formato no correcto");
        }
}
}
}
...
{ 
%>
<form action="upload.jsp?form=ok" enctype="multipart/form-data" name="form1" method="post">
<input type="file" name="file" /><br/>
<input type="submit" name="enviar" value="Upload" />
</form>
<% 
out.print(getServletContext().getRealPath("/archivos"));
} %> 
</body>
</html>